  ...
  <li class="splide__slide">
    <div class="it-single-slide-wrapper h-100 p-2">
      ...
      <article class="it-card it-card-image it-card-height-full rounded shadow-sm border">
          ...
          <div class="ratio ratio-21x9">
            <figure class="figure img-full">
                <?php if ((json_decode($item->images)->image_intro) ==''): ?>
                    <img src="<?php echo $templatePath; ?>/images/imgsegnaposto.jpg" alt="<?php echo htmlspecialchars($item->title, ENT_QUOTES, 'UTF-8'); ?>">
                <?php else: ?>   
        ...
        <!--finally the card footer link-->
        <div class="it-card-footer" aria-label="Link correlati:">
           <a class="read-more it-card-link" href="<?php echo $item->link; ?>">Scopri di più</a>			  
        </div>
      </article>
      <!--end it-card-->
    </div>
